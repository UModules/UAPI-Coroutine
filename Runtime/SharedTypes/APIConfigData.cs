...
namespace UAPIModule.SharedTypes
{
    public struct APIConfigData
    {
        ...
        public APIConfigData(BaseURLConfig baseURLConfig,
                             ...
                             int timeout,
                             bool useBearerPrefix) : this(baseURLConfig.BaseURL, endpoint, methodType, headers.ToDictionary(), needsAuthHeader, timeout, useBearerPrefix)
        {
        }

        public APIConfigData(string baseURL,
                             string endpoint,
                             HTTPRequestMethod methodType,
